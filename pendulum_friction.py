...
def G(y, t):
    ...
    # TODO: air resistant modeled too simply -- too aggressive
    theta1_dot, theta1 = y[0], y[1]
    air_resistance_coefficient = 0.5
    return np.array([-g / l1 * sin(theta1) - air_resistance_coefficient*l1**2*theta1_dot, theta1_dot])
